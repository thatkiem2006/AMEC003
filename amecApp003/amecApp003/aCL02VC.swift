...
class aCL02VC: UIViewController, GADBannerViewDelegate {
...
//        _viewAds.heightAnchor.constraint(equalToConstant: (28/446)*view.bounds.height).isActive = true
//        _viewAds.topAnchor.constraint(equalTo: view.topAnchor, constant: 0).isActive = true
//        _viewAds.backgroundColor = UIColor.red    
    }
    ...
    @IBAction func actionNext(_ sender: AnyObject) {
        ...
        self.performSegue(withIdentifier: "segueATE01", sender: nil)
    }
